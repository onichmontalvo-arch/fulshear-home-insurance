  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Insurance-specific conversion variants
        hero: "bg-gradient-accent text-accent-foreground hover:bg-accent-hover shadow-accent font-semibold",
        cta: "bg-accent text-accent-foreground hover:bg-accent-hover shadow-medium font-semibold",
        trust: "bg-secondary text-secondary-foreground hover:bg-secondary-hover shadow-soft",
        call: "bg-gradient-primary text-primary-foreground hover:bg-primary-hover shadow-medium font-semibold",
      },
      size: {
